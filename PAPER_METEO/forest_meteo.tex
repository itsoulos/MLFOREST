...
\begin{figure}[H]
\includegraphics[width=10.5cm]{Definitions/logo-mdpi} \caption{This is a figure. Schemes follow the same formatting. If there are
...
on a single line should be centered.\protect\label{fig1}}
\end{figure}
\unskip 

\begin{table}[H]
\caption{This is a table caption. Tables should be placed in the main text
near to the first time they are~cited.\protect\label{tab1}}
...
Entry 2 & Data & Data\textsuperscript{1}\tabularnewline
\bottomrule
\end{tabular*}

{\footnotesize\textsuperscript{{\footnotesize 1}}Tables may have
a footer.}{\footnotesize\par}
\end{table}
...
\caption{This is a wide figure.\protect\label{fig2}}
\end{figure}
\unskip 

\begin{table}[H]
\caption{This is a wide table.\protect\label{tab2}}


\begin{adjustwidth}{-\extralength}{0cm}{}

\begin{tabular*}{1\linewidth}{@{\extracolsep{\fill}}>{\centering}p{0.2\linewidth}>{\centering}p{0.25\linewidth}>{\centering}p{0.25\linewidth}>{\centering}p{0.25\linewidth}}
\toprule 
\textbf{Title 1} & \textbf{Title 2} & \textbf{Title 3} & \textbf{Title 4}\tabularnewline
\midrule 
\multirow{3}{*}{Entry 1\textsuperscript{{*}}} & Data & Data & Data\tabularnewline
 & Data & Data & Data\tabularnewline
 & Data & Data & Data\tabularnewline
\midrule 
\multirow{3}{*}{Entry 2} & Data & Data & Data\tabularnewline
 & Data & Data & Data\tabularnewline
 & Data & Data & Data\tabularnewline
\midrule
\multirow{3}{*}{Entry 3} & Data & Data & Data\tabularnewline
 & Data & Data & Data\tabularnewline
 & Data & Data & Data\tabularnewline
\midrule 
\multirow{3}{*}{Entry 4} & Data & Data & Data\tabularnewline
 & Data & Data & Data\tabularnewline
 & Data & Data & Data\tabularnewline
\bottomrule
\end{tabular*}
...
\noindent{\footnotesize{\textsuperscript{{*}} Tables may have a
footer.}}
\end{table}
...
\begin{table}[H]
\caption{This is a table caption. \protect\label{tab5}}
