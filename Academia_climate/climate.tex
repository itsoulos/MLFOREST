...
The 1.5\textdegree C target is highly ambitious and is likely to have been surpassed
...
Crossing \cite{Visual Crossing},with last accessed on
...
models, and satellite observations. Specifically, the data originate 
...
reached \textminus 14.3\textdegree C (6.2\textdegree F) on July 3, 1998. In Congo, the maximum
...
with varying magnitudes. Turkey recorded the highest rise at 1.92\textdegree C
...
\begin{figure}[H]
	\centering
\includegraphics[scale=0.80]{grammar_method(fig4)}
...
\begin{figure}[H]
\includegraphics[scale=0.70]{genclass_flowchart(fig7)}
\centering
...
The \tabref{Table-6-Experimental-results-on} summarizes the experimental
...
that each model must learn. For instance, CONGO lies close to the
...
\end{table}
The results summarized in \figref{Statistical-comparison-for}
...
\begin{figure}[H]
	\centering
\includegraphics[scale=0.4]{plot_kongo}
...
\begin{figure}[H]
\includegraphics[scale=0.8]{algorithm1}
\centering
...
In \tabref{Table-7-Experimental-results-on-1} evaluates the sensitivity
