...
for 2024 indicating an increase of approximately 2.65  Fahrenheit degrees
...
as seen in Figure
\ref{fig:NASA-Global-Temperature-1881}.
...
larger errors. At higher latitudes, ICELAND
...
(1.11\%), with NNC as the next best performer. Finally, CAPETOWN 
...
\begin{figure}[H]
\includegraphics[scale=0.35]{iceland_roc}\includegraphics[scale=0.35]{arabia_roc}

\includegraphics[scale=0.35]{svalbard_roc}\includegraphics[scale=0.35]{turkey_roc}
...
\begin{figure}[H]
\includegraphics[scale=0.35]{iceland_pr}\includegraphics[scale=0.35]{arabia_pr}

\includegraphics[scale=0.35]{svalbard_pr}\includegraphics[scale=0.35]{turkey_pr}
...
the program presented in figure \ref{alg:An-example-of} for the
...
\begin{figure}[H]
	\includegraphics[scale=0.8]{exectime}
...
The data used here are freely available.
...
\bibitem{Galv=0000E1n-L=0000F3pez 2010}Galvan-Lopez, E., Swafford,
...
\bibitem{Mart=0000EDnez=002010Rodr=0000EDguez 2020}Martínez-Rodriguez,
...
\bibitem{Castej=0000F3n 2018}Castejon, F., \& Carmona, E. J. Automatic
