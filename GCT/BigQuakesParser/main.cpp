...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    for(int i=0;i<finalQuake.size();i++)
    {
        if(i%500==0) printf("Done %.lf%%\n",i*100.0/finalQuake.size());
        for(int j=0;j<finalQuake.size();j++)
        {
            if(i==j) continue;
            int t1=finalQuake[i].year;
