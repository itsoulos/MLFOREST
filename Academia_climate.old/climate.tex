...
grammar for this method is provided in Figure \figref{The-underlying-grammar-method}. In this grammar the constant $D$ has the value $D=30$ since the number of features for the used data is set 30, as shown in Table \ref{tab:Table-2-structure-columns}. For example, the variable X2 encodes the minimum temperature etc.
\begin{figure}[H]
	\centering
