...
\AtBeginDocument{\providecommand\ref[1]{\ref{tabTable-5-:#1}}}
...
\author{Constantina Kopitsa\textsuperscript{1}, Ioannis G. Tsoulos\textsuperscript{2{*}},
Vasileios Charilogis\textsuperscript{3}}
\maketitle

\lyxaddress{\textsuperscript{1, 2, 3}Department of Informatics and Telecommunications,
...
impacts on the the planet and on all living organisms within its ecosystems.
Since 1969, the global surface temperature have been breaking previous
records almost annually, with NASA\textquoteright s final measurement
for 2024 indicating an increase of approximately 2.65° Fahrenheit
...
during the period 1995--2025 across Congo region, Saudi Arabia, Greece,
...
local populations of essential resources. Such accounts illustrate
...
to well below 2°C above pre-industrial levels, while encouraging efforts
to limit the increase to 1.5°C. Achieving these targets is recognized
...
conscious actions in the past, today, in the year 2025, NASA's data
indicate that the debate has shifted to whether humanity will surpass
the critical threshold of 1.5°C or 2.7°F global temperature \textit{\cite{NASA 2024}}.
...
Earth\textquoteright s temperature by approximately 5 - 6°C or 9 -
11°F. Since then, approximately 130 years have passed; nevertheless,
...
the world rising temperature\textit{\cite{Lindsey 2025}}. Mansfield
...
or patterns of the objective problem. In contrast to conventional
...
outlined in section \secref{Materials-and-methods}, the experimental
results are shown and discussed in \secref{Results} and finally a
detailed discussion is provided in \secref{Conclusions}.
...
from NASA Goddard's Scientific Visualization Studio:\url{https://svs.gsfc.nasa.gov/5450}
\figref{NASA-Global-Temperature-1881}.
...
\begin{figure}[H]
\includegraphics{1881-300dpi}\caption{Global Temperature 1881\label{fig:NASA-Global-Temperature-1881}}
\end{figure}

\begin{figure}[H]
\includegraphics{1995-300dpi}\caption{Global Temperature 1995\label{fig:NASA-Global-Temperature-1995}}
\end{figure}

\begin{figure}[H]
\includegraphics{2024-300dpi}\caption{Global Temperature 2024\label{fig:NASA-Global-Temperature-2024}}
\end{figure}
...
impacts of climate change. Our data were retrieved from the\textit{
(EM-DAT) Emergency Events Database\cite{EM-DATA}} \url{https://www.emdat.be/}
on 9 November 2025.

From 1900 to 2025, a total of major events were recorded, around the
world categorized as follows \tabref{Table-1-Hazards-1900--}
...
1, 1995, to December 13, 2025. Specifically, Turkey provides the most
...
\hline 
\textbf{\textcolor{blue}{Number}} & \textbf{\textcolor{blue}{Data}}\tabularnewline
\hline 
\hline 
...
\hline 
11 & Snow\tabularnewline
\hline 
12 & Snow depth\tabularnewline
\hline 
13 & Windgust\tabularnewline
\hline 
14 & Wind speed\tabularnewline
\hline 
15 & Wind dir\tabularnewline
\hline 
16 & Sea level pressure\tabularnewline
\hline 
17 & Cloud cover\tabularnewline
\hline 
18 & Visibility\tabularnewline
\hline 
19 & Solar radiation\tabularnewline
\hline 
20 & Solar energy\tabularnewline
\hline 
21 & Uvindex\tabularnewline
\hline 
22 & Severe risk\tabularnewline
\hline 
23 & Moon phase\tabularnewline
\hline 
24 & Temp max (Celsius)\tabularnewline
\hline 
25 & Temp min (Celsius)\tabularnewline
\hline 
26 & Year\tabularnewline
\hline 
27 & Month\tabularnewline
\hline 
28 & Day\tabularnewline
\hline 
29 & Class\tabularnewline
\hline 
 & \tabularnewline
\hline 
...
trend of warming consistent with the impacts of climate change \tabref{Table-3-Mean-Temperature-increased-1995-2025}. 
...
were assigned to Class 1 \tabref{Table-4-Region-Baseline-Class}.
...
grammar for this method is provided in Figure \figref{The-underlying-grammar-method}. 
...
stand for the input patterns and each value ti represents the actual
output for pattern $x_{i}$. The proposed method in practice uses
...
the current population. For every pair $\left(c_{1},c_{2}\right)$
...
one - point crossover \textit{\cite{Poli 1998}}. An example of this
...
Table \tabref{Table-6-Experimental-results-on} summarizes the experimental
...
used datasets.
\end{enumerate}
Table \tabref{Table-6-Experimental-results-on} reports the percentage
...
TURKEY). Since the entries are error percentages, lower values indicate
...
moisture. In this dataset, Table\tabref{Table-6-Experimental-results-on}
...
ranks second. Overall, the \tabref{Table-6-Experimental-results-on}
...
\hline 
\textbf{\textcolor{blue}{DATASET}} & \textbf{\textcolor{blue}{MLP}} & \textbf{\textcolor{blue}{RBF}} & \textbf{\textcolor{blue}{SVM}} & \textbf{\textcolor{blue}{NNC}} & \textbf{\textcolor{blue}{GENCLASS}}\tabularnewline
\hline 
\hline 
\textbf{Cape Town} & 14.89\% & 12.43\% & 17.18\% & 2.00\% & 0.97\%\tabularnewline
\hline 
\textbf{Greece} & 38.10\% & 4.34\% & 50.61\% & 6.15\% & 0.85\%\tabularnewline
\hline 
\textbf{Iceland} & 36.87\% & 7.09\% & 49.79\% & 6.33\% & 2.47\%\tabularnewline
\hline 
\textbf{Congo} & 26.52\% & 30.16\% & 32.71\% & 13.75\% & 4.84\%\tabularnewline
\hline 
\textbf{Arabia} & 41.63\% & 7.62\% & 48.94\% & 4.91\% & 0.73\%\tabularnewline
\hline 
\textbf{Svalbard} & 27.56\% & 23.30\% & 47.22\% & 5.07\% & 1.11\%\tabularnewline
\hline 
\textbf{Turkey} & 33.53\% & 7.81\% & 49.10\% & 5.05\% & 0.63\%\tabularnewline
\hline 
\textbf{Average} & 31.30\% & 13.25\% & 42.22\% & 6.18\% & 1.66\%\tabularnewline
\hline 
\end{tabular}
...
The results summarized in Figure\figref{Statistical-comparison-for}
indicate that the comparison GENCLASS vs MLP yields $p=0.0195$, implying
a statistically significant difference ($p<0.05$) and supporting
the conclusion that GENCLASS outperforms MLP under the adopted experimental
setting. The comparison GENCLASS vs RBF results in $p=0.2492$, which
is not significant (ns,$p>0.05$), therefore, given the available
datasets, there is insufficient statistical evidence to claim a systematic
performance difference between GENCLASS and RBF at the 5\% significance
level. In contrast, GENCLASS vs SVM yields $p=8.74\times10^{-5}$,
an extremely small value ($p<0.0001$), providing very strong statistical
evidence that GENCLASS outperforms SVM on the evaluated datasets.
The comparison GENCLASS vs NNC produces $p=0.6583$ (ns), suggesting
that no statistically significant difference can be established between
GENCLASS and NNC. Finally, the overall Friedman test reports$p=2.49\times10^{-5}$
...
\begin{figure}[H]
\includegraphics[scale=0.8]{stat-tbl3}

\caption{Statistical comparison for the results obtained by the application
of various machine learning methods\label{fig:Statistical-comparison-for}}
\end{figure}
...
The Figure\figref{Precision-and-recall} reports precision and recall
...
\begin{figure}[H]
\includegraphics[scale=0.8]{precisionAndRecall}
...
GENCLASS and for CONGO dataset is presented in Figure \figref{An-indicative-plot}.

\begin{figure}[H]
\includegraphics[scale=0.8]{plot_kongo}
...
in Figures \figref{Indicative-plots-for-ROC} and \figref{Indicative-plots-for-PR}
respectively.

\begin{figure}[H]
\includegraphics[scale=0.4]{iceland_roc}\includegraphics[scale=0.4]{arabia_roc}

\includegraphics[scale=0.4]{svalbard_roc}\includegraphics[scale=0.4]{turkey_roc}
...
\begin{figure}[H]
\includegraphics[scale=0.4]{iceland_pr}\includegraphics[scale=0.4]{arabia_pr}

\includegraphics[scale=0.4]{svalbard_pr}\includegraphics[scale=0.4]{turkey_pr}
...
\begin{algorithm}[H]
\includegraphics[scale=0.7]{algorithm1}

\caption{An example of classification program for the Greece dataset\label{alg:An-example-of}}
\end{algorithm}


\subsection{\textmd{Experiments with the number of chromosomes}}

Table \tabref{Table-7-Experimental-results-on-1} evaluates the sensitivity
...
$N_{c}$=50 to $N_{c}$=1000 occur for ARABIA (2.52\%\textrightarrow 0.54\%,
\textasciitilde 78.6\%) and TURKEY (2.37\%\textrightarrow 0.57\%,
\textasciitilde 75.9\%). In contrast, ICELAND exhibits a smaller
but consistent overall reduction (3.22\%\textrightarrow 2.14\%, \textasciitilde 33.5\%)
...
on the learning error of the proposed technique for a series of datasets\label{fig:stat-tb17.png}}
\end{figure}

Also, the average execution time for the proposed method and a variety
of values for the $N_{c}$ parameter is outlined in Figure\figref{Average-execution-time}.
As it was expected, the execution time increases rapidly as the number
of chromosomes increases.

\begin{figure}[H]
\includegraphics{exectime}
...
\tabref{Table-8-Experimental-results-on-Ng} investigates the effect
...
and an approximate 67.4\% relative decrease. The gains are not evenly
...
observed for TURKEY (2.63\%\textrightarrow 0.37\%, \textasciitilde 85.9\%)
and ARABIA (3.03\%\textrightarrow 0.63\%, \textasciitilde 79.2\%).
CONGO also improves markedly (14.12\%\textrightarrow 4.18\%, \textasciitilde 70.4\%)
...
relative improvement (4.32\%\textrightarrow 2.58\%, \textasciitilde 40.3\%)
...
of generations. Increasing $N_{g}$ also reduces cross-dataset variability:
...
error of the proposed method\label{fig:The-impact-of-stat-tb18}}
\end{figure}
...
from 10 to 30 and the corresponding results are listed in Table\tabref{Table-9-Experimental-RBF-results-using}

\begin{table}[H]
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline 
\textbf{Dataset} & \begin{cellvarwidth}[t]
\centering
RBF\\
$H=10$
...
The \figref{RBF-Sensitivity-to} is a heatmap of classification error
...
The effect of the number of generations$N_{g}$ is reported in \subsecref{Experiments-with-the}
, \tabref{Table-8-Experimental-results-on-Ng} and \figref{The-impact-of-stat-tb18}.
...
is consistent with the algorithm definition in Section \subsecref{The-proposed-method},
...
(\textpm 1°C and >1.1°C) for class definition while practical may
...
\bibitem{Aeschylus}Aeschylus, 472 B.C.The Persians. Place and date
...
\bibitem{Dey 2021} Dey, R., \& Lewis, S. C. Natural disasters linked
...
\bibitem{Kopitsa} Kopitsa, C., Tsoulos, I. G., Miltiadous, A., \&
...
\bibitem{United Nations} United Nations. Climate Action. {[}accessed
on 7 November 2025{]}.Available from: \url{https://www.un.org/en/climatechange/what-is-climate-change} 

\bibitem{United Nations 1992} United Nations. Climate Change. United
...
\bibitem{United Nations 1997} United Nations. Climate Change.The
...
\bibitem{Rolnick 2022} Rolnick, D., Donti, P. L., Kaack, L. H., Kochanski,
...
\bibitem{Xepapadeas 2024} Xepapadeas, P., Douvis, K., Kapsomenakis,
...
\bibitem{Knox 2000} Knox, J. C. Sensitivity of modern and Holocene
...
\bibitem{Angra 2022} Angra, D., \& Sapountzaki, K. Climate change
...
\bibitem{Stathi 2023} Stathi, E., Kastridis, A., \& Myronidis, D.Analysis
...
\bibitem{Yuan 2023} , X., Wang, Y., Ji, P., Wu, P., Sheffield, J.,
...
\bibitem{Kambezidis 2021} Kambezidis, H. D., Psiloglou, B. E., Varotsos,
...
\bibitem{Lindsey 2025} Lindsey, R. Dahlman, L. Climate change: global
...
\bibitem{Haq 2022} Haq, M. A. CDLSTM: A novel model for climate change
...
\bibitem{O'Neill 2002}O'Neill, M., \& Ryan, C. Grammatical evolution.
IEEE Transactions on Evolutionary Computation, 2002. 5(4), 349-358. 

\bibitem{Kramer 2017}Kramer, O. Genetic algorithms. In Genetic algorithm
essentials. Cham: Springer International Publishing. 2017. pp. 11-19.

\bibitem{Backus 1959}Backus, J. W. The syntax and the semantics of
the proposed international algebraic language of the Zurich ACM-GAMM
Conference. 1959. In ICIP Proceedings (pp. 125-132).

\bibitem{Ryan 1998}Ryan, C., Collins, J. J., \& Neill, M. O. Grammatical
...
\bibitem{Neill 1999}O\textquoteright Neill, M., \& Ryan, C.. Evolving
...
\bibitem{Brabazon 2006}Brabazon, A., \& O'Neill, M. Credit classification
using grammatical evolution. Informatica, 2006. 30(3).

\bibitem{Sen 2009}Sen, S., \& Clark, J. A. . A grammatical evolution
...
\bibitem{Chen 2008}Chen, L., Tan, C. H., Kao, S. J., \& Wang, T.
...
\bibitem{Hidalgo 2014}Hidalgo, J. I., Colmenar, J. M., Risco-Martin,
...
\bibitem{Tavares 2012}Tavares, J., \& Pereira, F. B. . Automatic
...
\bibitem{Zapater 2016}Zapater, M., Risco-Martín, J. L., Arroba, P.,
...
\bibitem{Ryan 1998-1}Ryan, C., O\textquoteright Neill, M., \& Collins,
...
\bibitem{de la Puente 2002}de la Puente, A. O., Alfonso, R. S., \&
...
\bibitem{De Campos 2016}De Campos, L. M. L., de Oliveira, R. C. L.,
...
\bibitem{Soltanian 2022}Soltanian, K., Ebnenasir, A., \& Afsharchi,
...
\bibitem{Dempsey 2007}Dempsey, I., O'Neill, M., \& Brabazon, A. Constant
creation in grammatical evolution. International Journal of Innovative
Computing and Applications, 2007. 1(1), 23-38.

\bibitem{Galv=0000E1n-L=0000F3pez 2010}Galván-López, E., Swafford,
...
\bibitem{Shaker 2012}Shaker, N., Nicolau, M., Yannakakis, G. N.,
...
\bibitem{Mart=0000EDnez=002010Rodr=0000EDguez 2020}Martínez-Rodríguez,
D., Colmenar, J. M., Hidalgo, J. I., Villanueva Micó, R. J., \& Salcedo-Sanz,
S. Particle swarm grammatical evolution for energy demand estimation.
Energy Science \& Engineering, 2020. 8(4), 1068-1079.

\bibitem{Sabar 2013}Sabar, N. R., Ayob, M., Kendall, G., \& Qu, R.
...
\bibitem{Ryan 2022}Ryan, C., Kshirsagar, M., Vaidya, G., Cunningham,
...
\bibitem{Pereira 2021}Pereira, P. J., Cortez, P., \& Mendes, R. Multi-objective
